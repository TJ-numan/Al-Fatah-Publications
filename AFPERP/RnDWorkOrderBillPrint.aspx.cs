...
namespace BLL
{
    public partial class RnDWorkOrderBillPrint : System.Web.UI.Page
    {
        string FormID = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    gvDateWiseWorkOrderDetails.DataSource = Li_RnDWorkOrderDetailsManager.GetLi_RnDWorkOrderBillPrintInfoByOrderNo(txtEmpName.Text.ToString(), int.Parse(Session["UserID"].ToString()));
        ...
        protected void gvDateWiseWorkDetails_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                try
                {
                    ...
                    rd.Load(Server.MapPath(@"~/Reports/RND/rptPrintWorkOrderBillStatusRz.rpt"));
