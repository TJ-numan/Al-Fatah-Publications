...
namespace BLL
{
    public partial class Mkt_Rpt_StockSummary : System.Web.UI.Page
    {
        string FormID = "MR055";
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "StockSummaryReport");
                rd.Close();
                rd.Dispose();
