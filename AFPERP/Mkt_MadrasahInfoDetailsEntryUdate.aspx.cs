...
namespace BLL
{
    public partial class Mkt_MadrasahInfoDetailsEntryUdate : System.Web.UI.Page
    {
        string FormID = "";
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dtexisEiin = Li_MadrasahInfoManager.GetLi_MadrasahInfo_ForExistingEIIN_ForUpdate(txteiin.Text.Trim()).Tables[0];
                if (dtexisEiin.Rows.Count > 0)
                {
                    

                        gvMRSheetDetailsUpdate.DataSource = dtexisEiin;
                        gvMRSheetDetailsUpdate.DataBind();

                        for (int i = 0; i < gvMRSheetDetailsUpdate.Rows.Count; i++)
                        {
                            GridViewRow gvwrow = gvMRSheetDetailsUpdate.Rows[i];
                            ((DropDownList)gvwrow.FindControl("ddlInstLevel")).SelectedValue = dtexisEiin.Rows[i]["MadLevelId"].ToString();
                        }
                ...
                else
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, GetType(), UniqueID, "alert('This EIIN not valid or No entry available');", true);
                    return;
                }
            ...
            try
            {
                for (int i = 0; i < gvMRSheetDetailsUpdate.Rows.Count; i++)
                {
                    ...
                    if (((DropDownList)gvwrow.FindControl("ddlInstLevel")).SelectedValue != "0")
                    {
                        ...
                        Li_MadrasahInfoManager.UpdateLi_MadrasahInfoAdvanced(liMadrasahInf);
                        ...
                        for (int j = 1; j <= 14; j++)
                        {
                            ...
                            switch (classNo)
                            {
                                ...
                                //    Li_StudentR2Manager.updateLi_StudentR2(listudent);
                                //    break;
                                case 1:
                                    listudent.ClassID = classNo;
                                    ...
                                    listudent.CreatedDate = DateTime.Now;
                                    listudent.FY_Year = "";
                                    Li_StudentR2Manager.UpdateLi_StudentAdvanced(listudent);
                                    break;
                                case 2:
                                    listudent.ClassID = classNo;
                        ...
                        for (int k = 1; k <= 6; k++)
                        {
                            ...
                            switch (teacherNo)
                            {
                                ...
                                case 1:
                                    ...
                                    Li_StudentR2Manager.UpdateLi_TeacherNoAdvanced(liNoOfTeacher);
                                    break;
                                case 2:
                                    liNoOfTeacher.Mad_Level_ID = teacherNo;
