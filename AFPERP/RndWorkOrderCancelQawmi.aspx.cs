...
namespace BLL
{
    public partial class RndWorkOrderCancelQawmi : System.Web.UI.Page
    {
        string FormID = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    getUserAccess();
                    gvWorkOderDetails.DataSource = Li_RnDQawmiWorkOrderDetailsManager.GetLi_RnDWorkOrderDetailsByWorkIDForUpdateAndDelete(txtWorkOrder.Text.ToString(), int.Parse(Session["UserID"].ToString()));
            ...
            try
            {
                for (int i = 0; i < gvWorkOderDetails.Rows.Count; i++)
                {
                    ...
                    if (chkRow.Checked == true)
                    {
                        ...
                        Li_RnDQawmiWorkOrderDetailsManager.Delete_Li_RnDWorkOrder(WorkOderBill);
