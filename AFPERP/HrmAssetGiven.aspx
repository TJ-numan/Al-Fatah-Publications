<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.master" AutoEventWireup="true" CodeBehind="HrmAssetGiven.aspx.cs" Inherits="BLL.HrmAssetGiven" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HRContent" runat="server">
       <div class="form-horizontal clearfix" runat="server">
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel panel-primary">
                <div class="panel-heading">
                    Employee Asset Given
                </div>
                <div class="panel-body">
                        ...
                        <div class="form-group">
                            <asp:Label runat="server" CssClass="control-label col-md-2 no-padding-right">Given Date</asp:Label>
                            <div class="col-md-4">
                                <asp:TextBox CssClass="form-control" ID="txtGivenDate" placeholder="dd-MM-yyyy" runat="server" />
                                <ajaxToolkit:CalendarExtender TargetControlID="txtGivenDate" Format="dd-MM-yyyy" runat="server" />
                            </div>
                        </div>

                        <div class="form-group">
                            <asp:Label AssociatedControlID="txtReqNo" runat="server" CssClass="control-label col-md-2 no-padding-right">Requisition No</asp:Label>
                            <div class="col-md-4">
                                <asp:TextBox runat="server" ID="txtReqNo" CssClass="form-control">
                                </asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <asp:Label AssociatedControlID="txtItemID" runat="server" CssClass="control-label col-md-2 no-padding-right">Item ID</asp:Label>
                            <div class="col-md-4">
                                <asp:TextBox runat="server" ID="txtItemID" CssClass="form-control">
                                </asp:TextBox>
                            </div>
                        </div>

                        <div class="form-group">
                            <asp:Label AssociatedControlID="txtQuantity" runat="server" CssClass="control-label col-md-2 no-padding-right">Quantity</asp:Label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <asp:Label AssociatedControlID="txtMeasureOfUnit" runat="server" CssClass="control-label col-md-2 no-padding-right">Measure of Unit</asp:Label>
                            <div class="col-md-4">
                                <asp:TextBox runat="server" ID="txtMeasureOfUnit" CssClass="form-control">
                                </asp:TextBox>
                            </div>
                        </div>
