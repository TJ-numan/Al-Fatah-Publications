...
namespace BLL
{
    public partial class Mkt_Rpt_TsowiseTransaction : System.Web.UI.Page
    {
        ...
        protected void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            rd.Load(Server.MapPath(@"~/Reports/MKT/rptTsowiseTransactions.rpt"));
            ...
            rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "TsowiseTransactionReport");
            rd.Close();
            rd.Dispose();
        }
