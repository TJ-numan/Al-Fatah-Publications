<%@ Page Title=""  Language="C#" MasterPageFile="~/MarketingMaster.Master" AutoEventWireup="true" CodeBehind="Rpt_AgentWiseTransaction.aspx.cs" Inherits="BLL.Rpt_AgentWiseTransaction" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MarketingContent" runat="server">
    <div class="form-horizontal clearfix" runat="server">
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel-success">
                <div class="panel-heading">
                  <h4>View Cash Agent wise Statement Report</h4>
                </div>
