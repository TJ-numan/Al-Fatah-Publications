...
namespace BLL
{
    public partial class Mkt_ThreeYearSalesComp : System.Web.UI.Page
    {
        ...
        {
            ddlClasses.DataSource = Li_ClassesManager.GetAllLi_Classess();
       ...
       //         ddlClasses.DataSource = Li_ClassesManager.GetAllLi_Classess();
       //         ddlClasses.DataTextField = "LibraryName";
       //         ddlClasses.DataValueField = "LibraryID";
       //         ddlClasses.DataBind();
       //         ddlClasses.Items.Insert(0, new ListItem("All", "0"));
       //    }
       //     catch (Exception)
       ...
       // }
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                rd.SetParameterValue("@ClassID", ddlClasses.SelectedValue);
                //rd.SetParameterValue("@UserID", int.Parse(Session["UserID"].ToString()));
                //rd.SetParameterValue("UserIP", Session["myIp"].ToString());

                rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "ClassList");
