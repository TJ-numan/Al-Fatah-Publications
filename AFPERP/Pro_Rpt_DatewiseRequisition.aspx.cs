...
namespace BLL
{
    public partial class Pro_Rpt_DatewiseRequisition : System.Web.UI.Page
    {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                rd.Load(Server.MapPath(@"~/Reports/MKT/rptPrintReqisitonDetail.rpt"));
                ...
                rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "Datewise Requisition Report");
            }
            catch (Exception ex)
            {
