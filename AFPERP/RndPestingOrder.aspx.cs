...
namespace BLL
{
    public partial class RndPestingOrder : System.Web.UI.Page
    {
        string FormID = "RF013";
        ...
        protected void btnPOSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    li_Pesting.FormaTotal = Decimal.Parse(txtTotalQty.Text);
                    li_Pesting.Pest_Bill_Forma = Decimal.Parse(txtFormaNoPestingBill.Text);
                    li_Pesting.Rate = Decimal.Parse(txtformaRate.Text);
                    li_Pesting.Amount = Decimal.Parse(txtAmount.Text);
