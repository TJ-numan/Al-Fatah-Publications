<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingMaster.master" AutoEventWireup="true" CodeBehind="Mkt_SpecimanAdj.aspx.cs" Inherits="BLL.Mkt_SpecimanAdj" %>
                    ...
                    <div class="row">
                        <div class="col-md-6 clearfix">
                            <div class="form-group">
                                <asp:Label runat="server" AssociatedControlID="txtMemoNo" CssClass="col-md-4 control-label no-padding-right" visible="False" Text="Memo No"></asp:Label>
                                <div class="col-md-8">
                                    <asp:TextBox runat="server" ID="txtMemoNo" CssClass="form-control" TabIndex="100" AutoPostBack="True" visible="False" OnTextChanged="txtChlNewMemoNo_TextChanged" />
                            ...
                            <div class="form-group">
                                <asp:Label runat="server" AssociatedControlID="txtChalanID" CssClass="col-md-4 control-label no-padding-right" Text="Chalan ID" visible="False"></asp:Label>
                                <div class="col-md-8">
                                    <asp:TextBox runat="server" ID="txtChalanID" CssClass="form-control" visible="False" ReadOnly="true"/>
                            ...
                            <div class="form-group">
                                <asp:Label runat="server" AssociatedControlID="txtChlNewDate" CssClass="col-md-4 control-label no-padding-right" visible="False" Text="Challan Date"></asp:Label>
                                <div class="col-md-8">
                                    <asp:TextBox runat="server" ID="txtChlNewDate" CssClass="form-control" placeholder="yyyy-mm-dd" visible="False" AutoPostBack="false" TabIndex="0" />
                    ...
                    <div class="clearfix table-responsive">
                        <table class=" table-responsive table no-head-padding ">
                            <tr>
                                ...
                                <td>
                                    <asp:Label runat="server" AssociatedControlID="txtChlQty" CssClass="control-label" Text="Chl Qty"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label runat="server" AssociatedControlID="txtAdjedQty" CssClass="control-label" Text="Adjusted"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label runat="server" AssociatedControlID="txtAvailQty" CssClass="control-label" Text="Avail Qty"></asp:Label>
                                </td>
<%--                                <td>
                                    <asp:Label runat="server" AssociatedControlID="txtIsDonation" CssClass="control-label" Text="Donation"></asp:Label>
                                </td>--%>
                                <td>
                            ...
                            <tr>
                                ...
                                <td style="width: 95px">
                                    <asp:TextBox runat="server" ID="txtChlQty" CssClass="form-control" ReadOnly="True" disabled="" />
                                </td>
                                <td style="width: 95px">
                                    <asp:TextBox runat="server" ID="txtAdjedQty" CssClass="form-control" ReadOnly="True" disabled="" />
                                </td>
                                <td style="width: 95px">
                                    <asp:TextBox runat="server" ID="txtAvailQty" CssClass="form-control" ReadOnly="True" disabled="" />
                                </td>
                                <%--<td style="width: 100px">
                                    <asp:DropDownList runat="server" ID="txtIsDonation" CssClass="form-control">
...
<asp:Content ID="Content4" ContentPlaceHolderID="RequiredJSMarketing" runat="server">
