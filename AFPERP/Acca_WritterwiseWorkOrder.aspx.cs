...
namespace BLL
{
    public partial class Acca_WritterwiseWorkOrder : System.Web.UI.Page
    {
        string FormID = "";
        ...
        protected void  ddlEmployeeFor_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            ddlEmpName.DataSource = Li_EmployeeInfoManager.GetLi_EmployeeListRZByEmployeer(int.Parse(ddlEmplyeeFor.SelectedValue.ToString()));
        ...
        {
            rd.Load(Server.MapPath(@"~/Reports/RND/rptPrintWritterwiseWorkOrder.rpt"));
            ...
            rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "WritterwiseRnDWorkOrder");
            rd.Close();
            rd.Dispose();
        }
