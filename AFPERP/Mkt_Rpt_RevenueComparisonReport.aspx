<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingMaster.master" AutoEventWireup="true" CodeBehind="Mkt_Rpt_RevenueComparisonReport.aspx.cs" Inherits="BLL.Mkt_Rpt_RevenueComparisonReport" %>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <asp:Label AssociatedControlID="txtLYCategory" runat="server" CssClass="col-md-4 control-label no-padding-right" Text="Last Year Category" />
                        <div class="input-group col-md-5">
                            <asp:TextBox ID="txtLYCategory" runat="server" CssClass="form-control">
                            </asp:TextBox>
                        </div>
                    </div>

                    <div class="form-group">
                        <asp:Label AssociatedControlID="txtCYCategory" runat="server" CssClass="col-md-4 control-label no-padding-right" Text="Current Year Category" />
                        <div class="input-group col-md-5">
                            <asp:TextBox ID="txtCYCategory" runat="server" CssClass="form-control">
                            </asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
