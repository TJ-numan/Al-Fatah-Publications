...
namespace BLL
{
    public partial class Mkt_TsoEnvelop : System.Web.UI.Page
    {
        ...
        private void LoadDemarcation()
        {
            try
            {
                ...
                else if (dtzone.Rows.Count == 1)
                {
                    ...
                    ddlTsoName.Items.Insert(0, new ListItem("All", ""));
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                rd.Load(Server.MapPath(@"~/Reports/MKT/Mkt_EnvelopPrint.rpt"));
                ...
                rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "TSOMail");
