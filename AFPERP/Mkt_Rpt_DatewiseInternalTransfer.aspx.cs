...
namespace BLL
{
    public partial class Mkt_Rpt_DatewiseInternalTransfer : System.Web.UI.Page
    {
        string FormID = "MR010";
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            ...
            rd.Load(Server.MapPath(@"~/Reports/MKT/rptDatewiseIntTransfer.rpt"));
            ...
            //rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "InternalTransferReport");
            ...
            {
                rd.ExportToHttpResponse(ExportFormatType.ExcelRecord, Response, false, "InternalTransferReport");
            }


            else if (ddlViewers.SelectedValue == "3")
            {
                rd.ExportToHttpResponse(ExportFormatType.WordForWindows, Response, false, "InternalTransferReport");
            }
