<%@ Page Title="" Language="C#" MasterPageFile="~/AccountingMaster.master" AutoEventWireup="true" CodeBehind="Acc_DatewiseMRSheet.aspx.cs" Inherits="BLL.Acc_DatewiseMRSheet" %>
                        ...
                        <div class="table-responsive table-bordered clearfix "  >
                            <asp:GridView ID="gvDateWiseMRSheet" CssClass="table " runat="server" AutoGenerateColumns="false" OnRowDataBound="gvDateWiseMRSheet_RowDataBound" OnSelectedIndexChanged="gvDateWiseMRSheet_SelectedIndexChanged">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="CreatedDate" HeaderText="MR Date"  DataFormatString="{0:dd/MM/yyyy}" />
                                    <asp:BoundField DataField="TotalAmount" HeaderText="TotalAmount"  ItemStyle-HorizontalAlign="Right"  DataFormatString="{0:N0}"/> 
...
<asp:Content ID="Content2" ContentPlaceHolderID="RequiredJSAcc" runat="server">
    ...
    <script type="text/javascript">
                $(function () {
                    $('[id*=gvDateWiseMRSheet]').prepend($("<thead></thead>").append($(this).find("tr:first"))).DataTable({
                        "responsive": true,
