<%@ Page Title="" Language="C#" MasterPageFile="~/ProductionMaster.master" AutoEventWireup="true" CodeBehind="Pro_Rpt_PrintCoverBill.aspx.cs" Inherits="BLL.Pro_Rpt_PrintCoverBill" %>
                    ...
                    <div class="col-md-12 no-padding clearfix">
                        <div class="col-md-6 clearfix">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <asp:DropDownList CssClass="form-control" ID="ddlSupplier" runat="server">
                                    </asp:DropDownList>
                                </div>
                            </div>
