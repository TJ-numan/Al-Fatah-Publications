...
namespace BLL
{ 
    public partial class Mkt_Rpt_BoisakhiOfferReport : System.Web.UI.Page
    {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                rd.Load(Server.MapPath(@"~/Reports/MKT/rptLibraryBoishakiSummmaryR2.rpt"));
                ...
                rd.SetParameterValue("@OfferID", int.Parse(ddlOffer.SelectedValue ));
                ...
                {
                    rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "BoisakhiOfferReport");
                }

                else if (ddlViewers.SelectedValue == "2")
                {
                    rd.ExportToHttpResponse(ExportFormatType.ExcelRecord, Response, false, "BoisakhiOfferReport");
                }


                else if (ddlViewers.SelectedValue == "3")
                {
                    rd.ExportToHttpResponse(ExportFormatType.WordForWindows, Response, false, "BoisakhiOfferReport");
                }
