...
namespace BLL
{
    public partial class Pro_PrintDatewiseDamagePlate : System.Web.UI.Page
    {
        string FormID = "MR014";
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            ...
            rd.Load(Server.MapPath(@"~/Reports/PRO/rptDatewiseDamagePlateChallan.rpt"));
            ...
            rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "DatewiseDamagePlate");
            rd.Close();
            rd.Dispose();
        }
