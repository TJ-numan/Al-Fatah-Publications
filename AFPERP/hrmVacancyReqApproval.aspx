<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.master" AutoEventWireup="true" CodeBehind="hrmVacancyReqApproval.aspx.cs" Inherits="BLL.hrmVacancyReqApproval" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HRContent" runat="server">
       <div class="form-horizontal clearfix" runat="server">
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel panel-primary">
                <div class="panel-heading">
                    Training Requisition Approval
                </div>
                <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:TextBox ID="ddlVacancy" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div> 
                        <div class="form-group">
