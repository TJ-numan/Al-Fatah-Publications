...
namespace BLL
{
    public partial class Mkt_Rpt_SalesTerget2020 : System.Web.UI.Page
    {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    rd.Load(Server.MapPath(@"~/Reports/MKT/rptProjectwiseTargetRz.rpt"));

                }
                if (chkIsQawmi.Checked == true)
                {
                    rd.Load(Server.MapPath(@"~/Reports/MKT/QAWMI/rptProjectwiseTargetQawmiRz.rpt"));                 
        ...
        protected void ddlRegionMain_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dt = li_RegionManager.GetRegionByRegionMainId("1").Tables[0];
