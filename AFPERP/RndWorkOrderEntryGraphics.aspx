<%@ Page Title="" Language="C#" MasterPageFile="~/RandDMaster.master" AutoEventWireup="true" CodeBehind="RndWorkOrderEntryGraphics.aspx.cs" Inherits="BLL.RndWorkOrderEntryGraphics" %>
    ...
    <div class="form-horizontal clearfix" runat="server">
        <div class="panel-body" style="border: 1px solid #BDC3CA">
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body" style="border: 1px solid #BDC3CA">
                            <div class="row">
                              ...
                              <div class="col-md-2">
                                    <asp:Label AssociatedControlID="txtUnit" ID="lbltxtUnit" CssClass="control-label no-padding-left" Text="Unit" runat="server"></asp:Label>
                                    <asp:TextBox CssClass="form-control date" ID="txtUnit" placeholder="Ex. 50" runat="server" />
                              </div>
                              <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <asp:GridView ID="gvDailyWorks" runat="server" AutoGenerateColumns="False" CssClass="table">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderStyle-Width="150px" HeaderText="Unit" DataField="unit" />                                   
            ...
            <div class="row">
                <div class="col-sm-12">                 
                    <div class="form-group">
                        <asp:Label AssociatedControlID="TxtTotUnit" CssClass="col-md-4 control-label" Text="Total Unit" runat="server"></asp:Label>
                        <div class="col-md-3">
                            <asp:TextBox CssClass="form-control" ID="TxtTotUnit" runat="server" readonly="true"/>
                        </div>
                    </div>
                    <div class="form-group">
