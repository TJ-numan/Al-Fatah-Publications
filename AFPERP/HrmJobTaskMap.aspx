<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.master" AutoEventWireup="true" CodeBehind="HrmJobTaskMap.aspx.cs" Inherits="BLL.HrmJobTaskMap" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel panel-primary">
                ...
                <div class="panel-body">
                        ...
                        <div class="form-group">
                            <asp:Label AssociatedControlID="ddlJobTask" runat="server" CssClass="control-label col-md-2 no-padding-right">Job Task</asp:Label>
                            <div class="col-md-4">
                                <asp:DropDownList ID="ddlJobTask" CssClass="form-control" runat="server"></asp:DropDownList>
                            </div>
                        </div>
