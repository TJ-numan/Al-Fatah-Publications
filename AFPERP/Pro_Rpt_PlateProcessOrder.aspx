<%@ Page Title="" Language="C#" MasterPageFile="~/ProductionMaster.master" AutoEventWireup="true" CodeBehind="Pro_Rpt_PlateProcessOrder.aspx.cs" Inherits="BLL.Pro_Rpt_PlateProcessOrder" %>
                ...
                <div class="panel-body">
                    <div class="col-md-12 no-padding clearfix">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <asp:Label runat="server" AssociatedControlID="ddlPress" CssClass="col-xs-4 control-label no-padding-right" Text="Select Press"></asp:Label>
                                <div class="col-xs-8">
                                    <asp:DropDownList ID="ddlPress" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddlPress_SelectedIndexChanged" />
                                </div>
                            </div>
                            <div class="form-group">
