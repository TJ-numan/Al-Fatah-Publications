<%@ Page Title="" Language="C#" MasterPageFile="~/RandDMaster.master" AutoEventWireup="true" CodeBehind="RndEntryWorks.aspx.cs" Inherits="BLL.RndEntryWorks" %>
...
<%--                            <div class="form-group">
                                <asp:Label AssociatedControlID="ddlDepartment" CssClass="col-md-3 control-label" Text="Department" runat="server"></asp:Label>
                                <div class="col-md-7">
                                    <asp:DropDownList CssClass="form-control" ID="ddlDepartment" runat="server" AutoPostBack="True" ReadOnly="True">
                                    </asp:DropDownList>
                                </div>
                            </div>--%>
                            <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                                <asp:Label AssociatedControlID="ddlSectionforBook" id="lblSectionforBook" CssClass="col-md-3 control-label" Text="Section for Book Selection" runat="server"></asp:Label>
                                <div class="col-md-7">
                                    <asp:DropDownList CssClass="form-control" ID="ddlSectionforBook" runat="server" OnTextChanged="ddlSectionforBook_TextChanged" AutoPostBack="True">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <asp:GridView ID="gvDailyWorks" runat="server" AutoGenerateColumns="False" CssClass="table">
                        <Columns>
                            ...
                            <asp:BoundField HeaderStyle-Width="150px" HeaderText="Section" DataField="SectionName" />
                            <asp:BoundField HeaderStyle-Width="200px" HeaderText="Employee" DataField="Employee" /> 
...
<asp:Content ID="Content2" ContentPlaceHolderID="RequiredJSRandD" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //$('#chkHireSection').change(function () {
            //    if (this.checked) $('.hireSection-div').removeClass('hide');
            //    else $('.hireSection-div').addClass('hide');
            //});
            //$(document).ready(function () {
            //    if (document.getElementById('_ispostback').value == 'true') $('.hireSection-div').removeClass('hide');
            //    else $('.hireSection-div').addClass('hide');
            //});
        });
    </script>
