<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingMaster.master" AutoEventWireup="true" CodeBehind="Mkt_Rpt_ThreeEditionComparisonReport.aspx.cs" Inherits="BLL.Mkt_Rpt_ThreeEditionComparisonReport" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    View Three Edition Comparison Report
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <asp:Label AssociatedControlID="txtEdition" CssClass="col-md-4 control-label" Text="Current Edition" runat="server"></asp:Label>
                        <div class="col-md-5">
