<%@ Page Title="" Language="C#" MasterPageFile="~/Distribution.master" AutoEventWireup="true" CodeBehind="Pro_SutrapurLami_ItemChallan.aspx.cs" Inherits="BLL.Pro_SutrapurLami_ItemChallan" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    Sutrapur Lamination Item Challan
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        <asp:Label runat="server" AssociatedControlID="txtChallanID" CssClass="col-md-4 control-label" Text="Challan ID"></asp:Label>
                        <div class="col-md-5">
                            <asp:TextBox ID="txtChallanID" runat="server" CssClass="form-control" placeholder="ChallanID or MemoNo" />
                        </div>
                    </div>
                    <div class="form-group">
                        <asp:Label runat="server" AssociatedControlID="txtRefNo" CssClass="col-md-4 control-label" Text="Ref. No"></asp:Label>
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label1" runat="server" AssociatedControlID="ddlPartyName" CssClass="col-md-4 control-label" Text="Party Name"></asp:Label>
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <asp:Label runat="server" AssociatedControlID="dtpChallanDate" CssClass="col-md-4 control-label" Text="Challan Date"></asp:Label>
                        <div class="col-md-5">
                            <asp:TextBox ID="dtpChallanDate" runat="server" CssClass="form-control" placeholder="yyyy-MM-dd" />
                            <ajaxToolkit:CalendarExtender runat="server" Format="yyyy-MM-dd" TargetControlID="dtpChallanDate" />
                        </div>
                    </div>
