<%@ Page Title="" Language="C#" MasterPageFile="~/ProductionMaster.master" AutoEventWireup="true" CodeBehind="Pro_Rpt_LeminationChallanMemo.aspx.cs" Inherits="BLL.Pro_Rpt_LeminationChallanMemo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ProductionContent" runat="server">
       <div class="form-horizontal clearfix" runat="server">
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel-primary">
                <div class="panel-heading">
                   Print Lemination Challan Memo
                </div>
                    ...
                    <div class="col-md-12 no-padding clearfix">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <asp:TextBox ID="txtMemoNo" runat="server" CssClass="form-control" AutoPostBack="True"/>
                                </div>
                            </div>
                                                        <div class="form-group">
