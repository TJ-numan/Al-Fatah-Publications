...
namespace BLL
{
    public partial class Mkt_Rpt_SpecimanChallanByBookId : System.Web.UI.Page
    {
...
ReportDocument rd = new ReportDocument();
        protected void btnLoad_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                rd.Load(Server.MapPath(@"~/Reports/MKT/rptTSOChalanByBookID.rpt"));
                ...
                rd.SetParameterValue("@TSOID", null);
                rd.SetParameterValue("@userID", int.Parse(Session["UserID"].ToString()));
                rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "SpecimanChalanReport");
                rd.Close();
                rd.Dispose();
            }
            catch (Exception ex)
