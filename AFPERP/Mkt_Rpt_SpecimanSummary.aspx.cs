...
namespace BLL
{
    public partial class Mkt_Rpt_SpecimanSummary : System.Web.UI.Page
    {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                rd.Load(Server.MapPath(@"~/Reports/MKT/rptTsoWholeYearReport_R2.rpt"));
                //rd.Load(Server.MapPath(@"~/Reports/MKT/rptTsoWholeYearReport_R2_Test.rpt"));
