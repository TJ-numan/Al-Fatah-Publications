<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.master" AutoEventWireup="true" CodeBehind="HrmAssetDelivery.aspx.cs" Inherits="BLL.HrmAssetDelivery" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <asp:Label AssociatedControlID="txtRefNo" runat="server" CssClass="control-label col-md-2 no-padding-right">Reference No</asp:Label>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <asp:Label AssociatedControlID="ddlAssetName" runat="server" CssClass="control-label col-md-2 no-padding-right">Asset</asp:Label>
                        <div class="col-md-4">
                            <asp:DropDownList ID="ddlAssetName" CssClass="form-control" runat="server"></asp:DropDownList>
                        </div>
                    </div>
