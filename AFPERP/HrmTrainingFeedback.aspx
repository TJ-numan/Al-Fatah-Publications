<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.master" AutoEventWireup="true" CodeBehind="HrmTrainingFeedback.aspx.cs" Inherits="BLL.HrmTrainingFeedback" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel panel-primary">
                ...
                <div class="panel-body">
                        ...
                        <div class="form-group">
                            <asp:Label AssociatedControlID="txtTrainingFeedback" runat="server" CssClass="control-label col-md-2 no-padding-right">Training Feedback</asp:Label>
                            <div class="col-md-4">
                                <asp:TextBox ID="txtTrainingFeedback" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>  
                        <div class="form-group">
