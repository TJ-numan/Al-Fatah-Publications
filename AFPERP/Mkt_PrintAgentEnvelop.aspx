<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingMaster.master" AutoEventWireup="true" CodeBehind="Mkt_PrintAgentEnvelop.aspx.cs" Inherits="BLL.Mkt_PrintAgentEnvelop" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="RequiredJSMarketing" runat="server">
        <script type="text/javascript">
            $(document).ready(function () {
                open_menu("Reports", "Envelop Print");
            });
        </script>
</asp:Content>
