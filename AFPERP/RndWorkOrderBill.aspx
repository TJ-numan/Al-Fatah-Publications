<%@ Page Title="" Language="C#" MasterPageFile="~/RandDMaster.master" AutoEventWireup="true" CodeBehind="RndWorkOrderBill.aspx.cs" Inherits="BLL.RndWorkOrderBill" %>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                <asp:Label AssociatedControlID="txtWorkID" ID="lbltxtWorkID" CssClass="col-md-4 control-label no-padding-right" Text="Bill No" runat="server"></asp:Label>
                                <div class="col-md-6">  
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <asp:Button ID="btnShow" Text="Show Bill" CssClass="btn btn-success" runat="server" OnClick="btnShow_Click" />
                                </div>
                           </div>
                        </div>
                     </div>
