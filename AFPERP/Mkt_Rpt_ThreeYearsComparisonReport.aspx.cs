...
namespace BLL
{
    public partial class Mkt_Rpt_ThreeYearsComparisonReport : System.Web.UI.Page
    {
        ...
        //{
        //    ddlBookInfo.DataSource = li_BookInformationManager.Get_BookInformations_ComboSourceData();
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //rd.Load(Server.MapPath(@"~/Reports/MKT/rptThreeYearsChallanComparison.rpt"));
                rd.Load(Server.MapPath(@"~/Reports/MKT/rptThreeYearsChallanComparison-Test.rpt"));
                ...
                {
                    rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "Three Years Comparison Report");
                }

                else if (ddlViewers.SelectedValue == "2")
                {
                    rd.ExportToHttpResponse(ExportFormatType. ExcelRecord , Response, false, "Three Years Comparison Report");
                }


                else if (ddlViewers.SelectedValue == "3")
                {
                    rd.ExportToHttpResponse(ExportFormatType.WordForWindows, Response, false, "Three Years Comparison Report");
                }
