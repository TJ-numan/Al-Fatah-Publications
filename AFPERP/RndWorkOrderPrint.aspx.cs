...
namespace BLL
{
    public partial class RndWorkOrderPrint : System.Web.UI.Page
    {
        string FormID = "RF004";
        ...
        {
            rd.Load(Server.MapPath(@"~/Reports/RND/rptPrintDatewiseRnDWorkOrderDetails.rpt"));
            ...
            rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "DatewiseRnDWorkOrder");
            rd.Close();
            rd.Dispose();
        }
