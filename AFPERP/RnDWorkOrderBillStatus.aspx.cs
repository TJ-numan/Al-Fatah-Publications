...
namespace BLL
{
    public partial class RnDWorkOrderBillStatus : System.Web.UI.Page
    {
        string FormID = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    getUserAccess();
                    gvWorkOderDetails.DataSource = Li_RnDWorkOrderDetailsManager.GetLi_RnDWorkOrderBillStatus(txtWorkOrder.Text.ToString(), int.Parse(Session["UserID"].ToString()));
                    ...
                    for (int i = 0; i < gvWorkOderDetails.Rows.Count; i++)
                    {
                        ...
                        {
                            paid.Enabled = false;
                            paid.BackColor = System.Drawing.Color.Yellow;
                        }
                        else if (paid.Text == "Deleted")
                        {
                            paid.Enabled = false;
