...
namespace BLL
{
    public partial class Pro_RptDatewiseBookWisePrintReqVSReceived : System.Web.UI.Page
    {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                rd.Load(Server.MapPath(@"~/Reports/MKT/CASH/rptBookWisePrintReqVsGodown.rpt"));
                rd.DataSourceConnections.Clear();
                rd.DataSourceConnections[0].SetConnection(DAO.ServerName, DAO.DatabaseName, false);
                rd.DataSourceConnections[0].SetLogon(DAO.UserID, DAO.Password);
                rd.SetParameterValue("@BookAcCode", ddlBookName.SelectedValue.ToString());
                rd.SetParameterValue("@ClassID", int.Parse(ddlClass.SelectedValue.ToString()));
                ...
                rd.SetParameterValue("@Com", chkIsQawmi.Checked ? 1 : 0); 
                //------------------------------------------Print------------------------------------------------------
                ...
                {
                    rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "PrintRequisitionVSGodownReceived");
                }

                else if (ddlViewers.SelectedValue == "2")
                {
                    rd.ExportToHttpResponse(ExportFormatType.ExcelRecord, Response, false, "PrintRequisitionVSGodownReceived");
                }


                else if (ddlViewers.SelectedValue == "3")
                {
                    rd.ExportToHttpResponse(ExportFormatType.WordForWindows, Response, false, "PrintRequisitionVSGodownReceived");
                }
