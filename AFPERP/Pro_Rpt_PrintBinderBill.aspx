<%@ Page Title="" Language="C#" MasterPageFile="~/ProductionMaster.master" AutoEventWireup="true" CodeBehind="Pro_Rpt_PrintBinderBill.aspx.cs" Inherits="BLL.Pro_Rpt_PrintBinderBill" %>
                ...
                <div class="panel-body">
                    <div class="col-md-12 no-padding clearfix">
                        <div class="col-md-6 clearfix">
                            ...
                            <div class="form-group">
                                <asp:Label runat="server" AssociatedControlID="ddlBinder" CssClass="col-xs-4 control-label no-padding-right" Text="Binder"></asp:Label>
                                <div class="col-xs-8">
                                    <asp:DropDownList ID="ddlBinder" runat="server" CssClass="form-control"></asp:DropDownList>
                                </div>
                            </div>
                            <div class="form-group">
