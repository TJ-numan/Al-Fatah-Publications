<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.master" AutoEventWireup="true" CodeBehind="HrmPFDistribution.aspx.cs" Inherits="BLL.HrmPFDistribution" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel panel-primary">
                ...
                <div class="panel-body">
                        ...
                        <div class="form-group">
                            <asp:Label AssociatedControlID="txtPFAccountNo" runat="server" CssClass="control-label col-md-2 no-padding-right">PF Acc. No</asp:Label>
                            <div class="col-md-4">
                                <asp:TextBox ID="txtPFAccountNo" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <asp:Label AssociatedControlID="txtTranPurpose" runat="server" CssClass="control-label col-md-2 no-padding-right">Trans. Purpose</asp:Label>
                            <div class="col-md-4">
                                <asp:TextBox ID="txtTranPurpose" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
