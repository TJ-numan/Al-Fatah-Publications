...
namespace BLL
{
    public partial class Mkt_Rpt_AgentList : System.Web.UI.Page
    {
       ...
       protected void ddlTeritory_SelectedIndexChanged(object sender, EventArgs e)
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ddlLibrary.SelectedValue != "0")
                {
                //    rd.Load(Server.MapPath(@"~/Reports/MKT/rptLibraryInformation.rpt"));
                      rd.Load(Server.MapPath(@"~/Reports/MKT/rptLibraryInformationSingle.rpt"));
