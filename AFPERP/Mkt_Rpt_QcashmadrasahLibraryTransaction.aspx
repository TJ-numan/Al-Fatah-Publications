<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingMaster.master" AutoEventWireup="true" CodeBehind="Mkt_Rpt_QcashmadrasahLibraryTransaction.aspx.cs" Inherits="BLL.Mkt_Rpt_QcashmadrasahLibraryTransaction" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MarketingContent" runat="server">
<div class="form-horizontal clearfix" runat="server">
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    View QCash Library Transaction
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        <asp:Label AssociatedControlID="dtpFromDate" CssClass="col-md-4 control-label" Text="From" runat="server"></asp:Label>
                        <div class="col-md-5">
                            <asp:TextBox CssClass="form-control date" ID="dtpFromDate" runat="server" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <asp:TextBox CssClass="form-control date" ID="dtpToDate" runat="server" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="dropdown col-md-5">
                            <asp:DropDownList ID="ddlCompany" runat="server" CssClass="form-control">
                                <asp:ListItem Value="2">Maktabatul Fatah Sales Center</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-md-8 col-md-offset-4">
                            <asp:CheckBox ID="chkIsAgent" CssClass="checkbox pull-left" runat="server" />
                            <asp:Label AssociatedControlID="chkIsAgent" CssClass="control-label" runat="server" Text="With Agent"></asp:Label>
                        </div>
                    </div>
                    <div class="form-group">
