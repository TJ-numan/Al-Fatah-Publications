...
namespace BLL
{
    public partial class Rnd_Rpt_DailyWorkIndividual : System.Web.UI.Page 
    {
        string FormID = "RF007";
        ...
        private void LoadEmployee(int id)
        {
            ...
            ddlEmployee.DataSource = Li_EmployeeInfoManager.GetLi_EmployeeListBySecID(id);
        ...
        protected void btnShow_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                rd.Load(Server.MapPath(@"~/Reports/RND/rptDailyWorkReportByEmployeeID.rpt"));
        ...
        protected void btnDownloadExcel_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand command = new SqlCommand("SMPM_li_rptRND_DailyReportByEmployee", connection);
                ...
                Response.AddHeader("content-disposition", "attachment;filename=IndividualDailyWorks.xls");
