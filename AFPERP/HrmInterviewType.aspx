<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.master" AutoEventWireup="true" CodeBehind="HrmInterviewType.aspx.cs" Inherits="BLL.HrmInterviewType" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel panel-primary">
                ...
                <div class="panel-body">
                        ...
                        <div class="form-group">
                            <asp:Label AssociatedControlID="txtInterviewType" runat="server" CssClass="control-label col-md-2 no-padding-right">Interview Type</asp:Label>
                            <div class="col-md-4">
                                <asp:TextBox ID="txtInterviewType" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>              
