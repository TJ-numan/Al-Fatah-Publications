<%@ Page Title="Paper Transfer" Language="C#" MasterPageFile="~/ProductionMaster.master" AutoEventWireup="true" CodeBehind="Pro_PaperTransfer.aspx.cs" Inherits="BLL.Pro_PaperTransfer" %>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <asp:TextBox ID="txtPaperTotalAmount" runat="server" CssClass="form-control calc" placeholder="0" Enabled="false" />
                        </div>
                    </div>
                    <div class="form-group">
