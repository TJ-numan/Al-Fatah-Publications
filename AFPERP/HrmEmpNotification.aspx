<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.master" AutoEventWireup="true" CodeBehind="HrmEmpNotification.aspx.cs" Inherits="BLL.HrmEmpNotification" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <asp:Label AssociatedControlID="txtNotcTitle" runat="server" CssClass="control-label col-md-2 no-padding-right">Notification Title</asp:Label>
                        <div class="col-md-4">
                            <asp:TextBox ID="txtNotcTitle" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                    </div>

                    <div class="form-group">
                        <asp:Label AssociatedControlID="txtNotcDescr" runat="server" CssClass="control-label col-md-2 no-padding-right">Notification Description</asp:Label>
                        <div class="col-md-4">
                            <asp:TextBox ID="txtNotcDescr" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                    </div>
