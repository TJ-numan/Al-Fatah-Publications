<%@ Page Title="" Language="C#" MasterPageFile="~/RandDMaster.master" AutoEventWireup="true" CodeBehind="RndWorkOrderBillGenerate.aspx.cs" Inherits="BLL.RndWorkOrderBillGenerate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="RandDContent" runat="server">
    <div class="form-horizontal clearfix" runat="server">
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    Work Order Bill Generate
                </div>
...
<%--                                    <asp:BoundField DataField="PageStart" HeaderText=" To Page"/>
                                    ...
                                    <asp:TemplateField HeaderText="Rate" HeaderStyle-Width="50px">
                                          <ItemTemplate>
                                               <asp:TextBox ID="txtRate" runat="server"  CssClass="click pl-qty" placeholder="0" data-field="pl-qty" Width="80px" ReadOnly="true"></asp:TextBox>
                                          </ItemTemplate>
                                    </asp:TemplateField>      
