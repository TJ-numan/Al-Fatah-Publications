<%@ Page Title="" Language="C#" MasterPageFile="~/AccountingMaster.master" AutoEventWireup="true" CodeBehind="MktCollectionDeposit.aspx.cs" Inherits="BLL.MktCollectionDeposit" %>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <asp:DropDownList ID="ddlCom" runat="server" CssClass="form-control">
                                        ...
                                        <asp:ListItem Value="2" Text="Ibtedaye"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <ajaxToolkit:CalendarExtender  ID="Calender1"  runat="server" Format="yyyy-MM-dd" TargetControlID="txtMemoDate" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <ajaxToolkit:CalendarExtender  ID="Calender2"  runat="server" Format="yyyy-MM-dd" TargetControlID="txtDepositedDate" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <ajaxToolkit:CalendarExtender  ID="Calender3"  runat="server" Format="yyyy-MM-dd" TargetControlID="txtClearanceDate" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    ...
                                    <asp:Button ID="btnUpdate" Text="Update" CssClass="btn btn-primary" runat="server" OnClick="btnUpdate_OnClick" />
