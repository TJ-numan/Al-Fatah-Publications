<%@ Page Title="" Language="C#" MasterPageFile="~/ManagementMaster.Master" AutoEventWireup="true" CodeBehind="MD_DateWiseSummaryReport.aspx.cs" Inherits="BLL.MD_DateWiseSummaryReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="RequiredJSPro" runat="server">
    <script type="text/javascript">
            $(document).ready(function () {
                open_menu("Reports", "Summary Report");
            });
    </script>
</asp:Content>
