<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingMaster.master" AutoEventWireup="true" CodeBehind="Mkt_Rpt_DatewiseChallanMemo.aspx.cs" Inherits="BLL.Mkt_Rpt_DatewiseChallanMemo" %>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="input-group col-md-8 col-md-offset-4">
                            <asp:CheckBox CssClass="" ID="chkBoishaki" runat="server" />
                            <asp:Label AssociatedControlID="chkBoishaki" CssClass="control-label" runat="server" Text="Boishaki"></asp:Label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group col-md-8 col-md-offset-4">
                            <asp:CheckBox CssClass="" ID="CheckAliaCash" runat="server" />
                            <asp:Label AssociatedControlID="CheckAliaCash" CssClass="control-label" runat="server" Text="Alia Cash"></asp:Label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group col-md-8 col-md-offset-4">
                            <asp:CheckBox CssClass="" ID="CheckQawmiCash" runat="server" />
                            <asp:Label AssociatedControlID="CheckQawmiCash" CssClass="control-label" runat="server" Text="Qawmi Cash"></asp:Label>
                        </div>
                    </div>
                    <div class="form-group">
