...
namespace BLL
{
    public partial class Pro_Rpt_BookWiseReport : System.Web.UI.Page
    {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                rd.Load(Server.MapPath(@"~/Reports/PRO/rptBookReceiveQtyByBookCode.rpt"));
                ...
                rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "Binding Delivery Report");
            }
            catch (Exception ex)
            {
