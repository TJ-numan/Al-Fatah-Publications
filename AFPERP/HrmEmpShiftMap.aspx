<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.master" AutoEventWireup="true" CodeBehind="HrmEmpShiftMap.aspx.cs" Inherits="BLL.HrmEmpShiftMap" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <asp:DropDownList ID="ddlDesignation"0 runat="server" CssClass="form-control" AutoPostBack="false"></asp:DropDownList>
                                </div>
                    ...
                    <div class="form-group">
                        <asp:Label AssociatedControlID="ddlOffSchedule" runat="server" CssClass="control-label col-md-2 no-padding-right">Select Schedule</asp:Label>
                        <div class="col-md-4">
