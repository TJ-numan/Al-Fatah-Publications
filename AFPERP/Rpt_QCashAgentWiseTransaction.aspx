<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingMaster.master" AutoEventWireup="true" CodeBehind="Rpt_QCashAgentWiseTransaction.aspx.cs" Inherits="BLL.Rpt_QCashAgentWiseTransaction" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MarketingContent" runat="server">
    <div class="form-horizontal clearfix" runat="server">
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel-success">
                <div class="panel-heading">
                  <h4>View QCash Agent wise Statement Report</h4>
                </div>
