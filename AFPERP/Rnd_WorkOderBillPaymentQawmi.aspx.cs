...
namespace BLL
{
    public partial class Rnd_WorkOderBillPaymentQawmi : System.Web.UI.Page
    {
        string FormID = "";
        ...
        protected void btnApprove_Click(object sender, EventArgs e)
        {
            try
            {
                for (int i = 0; i < gvWorkOderDetails.Rows.Count; i++)
                {
                    ...
                    Li_RnDQawmiWorkOrderDetailsManager.ApprovalLi_RnDWorkOrderBill(WorkOderBill);
                }
        ...
        protected void btnPrint_OnClick(object sender, EventArgs e)
        {
            try
            {
                rd.Load(Server.MapPath(@"~/Reports/RND/rptPrintWorkOrderBillStatusQawmi.rpt"));
