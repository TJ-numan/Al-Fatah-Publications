<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.master" AutoEventWireup="true" CodeBehind="HrmWeekend.aspx.cs" Inherits="BLL.HrmWeekend" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <asp:Label AssociatedControlID="txtWeekendDay" runat="server" CssClass="control-label col-md-2 no-padding-right">Weekend Day Name</asp:Label>
                        <div class="col-md-4">
                            <asp:TextBox ID="txtWeekendDay" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
                        <asp:Label AssociatedControlID="chkIsWorkingDay" runat="server" CssClass="control-label col-md-2 no-padding-right">Is working day</asp:Label>
                        <div class="col-md-4">
                            <asp:CheckBox ID="chkIsWorkingDay" CssClass="form-control" runat="server"></asp:CheckBox>
                        </div>
                    </div>
                    <div class="form-group">
                        <asp:Label AssociatedControlID="chkIsHalfDay" runat="server" CssClass="control-label col-md-2 no-padding-right">Is half day</asp:Label>
                        <div class="col-md-4">
                            <asp:CheckBox ID="chkIsHalfDay" CssClass="form-control" runat="server"></asp:CheckBox>
                        </div>
                    </div>
