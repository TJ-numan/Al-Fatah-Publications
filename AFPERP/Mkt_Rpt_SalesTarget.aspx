<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingMaster.master" AutoEventWireup="true" CodeBehind="Mkt_Rpt_SalesTarget.aspx.cs" Inherits="BLL.Mkt_Rpt_SalesTarget" %>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                      <div class="form-group">
                        <asp:Label AssociatedControlID="ddlSalesTargetBase" CssClass="col-md-4 control-label" Text="Sales Target" runat="server"></asp:Label>
                        <div class="col-md-5">
                            <asp:DropDownList CssClass="form-control" ID="ddlSalesTargetBase" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlSalesTargetBase_SelectedIndexChanged">
                                <asp:ListItem Value="">--Select--</asp:ListItem>
                            </asp:DropDownList>
                        </div>                    </div>
                    <div class="form-group">
                        <asp:Label AssociatedControlID="dtpFromDate" CssClass="col-md-4 control-label no-padding-left" Text="From Date" runat="server"></asp:Label>
                    ...
                    <div class="form-group">
                        <asp:Label AssociatedControlID="dtpToDate" CssClass="col-md-4 control-label no-padding-left" Text="To Date " runat="server"></asp:Label>
                        <div class="input-group col-md-5">
                    ...
                    <div class="form-group">
                        <asp:Label AssociatedControlID="ddlRegion" runat="server" CssClass="col-md-4 control-label no-padding-left" Text="Region" />
                        <div class="dropdown col-md-5">
                    ...
                    <div class="form-group">
                        <asp:Label AssociatedControlID="ddlDivision" runat="server" CssClass="col-md-4 control-label no-padding-left" Text="Division" />
                        <div class="dropdown col-md-5">
                    ...
                    <div class="form-group">
                        <asp:Label AssociatedControlID="ddlZone" runat="server" CssClass="col-md-4 control-label no-padding-left" Text="Zone" />
                        <div class="dropdown col-md-5">
                            <asp:DropDownList ID="ddlZone" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddlZone_SelectedIndexChanged"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="form-group">
                        <asp:Label AssociatedControlID="ddlTeritory" runat="server" CssClass="col-md-4 control-label no-padding-left" Text="Teritory" />
                        <div class="dropdown col-md-5">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <asp:DropDownList CssClass="form-control" ID="ddlCategory" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlSession_SelectedIndexChanged">
                                <asp:ListItem Value="">--Select--</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <asp:DropDownList CssClass="form-control" ID="ddlSession" runat="server" OnSelectedIndexChanged="ddlSession_SelectedIndexChanged" AutoPostBack="true">
                    ...
                    <div class="form-group">
                        <asp:Label AssociatedControlID="ddlBookInfo" CssClass="col-md-4 control-label" Text="BookName " runat="server"></asp:Label>
                        <div class="col-md-5">
                            <asp:DropDownList CssClass="form-control" ID="ddlBookInfo" runat="server" >
