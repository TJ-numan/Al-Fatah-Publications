<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.master" AutoEventWireup="true" CodeBehind="HrmCompetency.aspx.cs" Inherits="BLL.HrmCompetency" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel panel-primary">
                ...
                <div class="panel-body">
                        ...
                        <div class="form-group">
                            <asp:Label AssociatedControlID="txtCompetency" runat="server" CssClass="control-label col-md-2 no-padding-right">Competency</asp:Label>
                            <div class="col-md-4">
                                <asp:TextBox ID="txtCompetency" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
