<%@ Page Title="" Language="C#" MasterPageFile="~/ProductionMaster.master" AutoEventWireup="true" CodeBehind="Pro_Rpt_BookPriceList.aspx.cs" Inherits="BLL.Pro_Rpt_BookPriceList" %>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <asp:Label AssociatedControlID="ddlCategory" runat="server" CssClass="col-md-4 control-label no-padding-right" Text="Category" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="dropdown col-md-4">
                            <asp:DropDownList ID="ddlBookType" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddlType_SelectedIndexChanged">
                    ...
                    <div class="form-group">
                        ...
                        <div class="dropdown col-md-4">
                            <asp:DropDownList ID="ddlBookName" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddlBookName_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="form-group">
