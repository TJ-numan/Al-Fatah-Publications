...
namespace BLL
{
    public partial class Mkt_Rpt_StockReturnDetails : System.Web.UI.Page
    {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                    ...
                    rd.Load(Server.MapPath(@"~/Reports/MKT/rptStockReturnDetails.rpt"));
                ...
                rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "BookStockReturnDetailsReport");
                rd.Close();
                rd.Dispose();
