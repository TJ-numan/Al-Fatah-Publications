<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingMaster.master" AutoEventWireup="true" CodeBehind="Mkt_ThreeYearSalesComp.aspx.cs" Inherits="BLL.Mkt_ThreeYearSalesComp" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    View Project Wise Comparison Report
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <asp:Label AssociatedControlID="ddlClasses" CssClass="col-md-4 control-label" Text="Class Name" runat="server"></asp:Label>
                        <div class="col-md-5">
                            <asp:DropDownList CssClass="form-control" ID="ddlClasses" runat="server"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="form-group">
