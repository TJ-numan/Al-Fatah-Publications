<%@ Page Title="" Language="C#" MasterPageFile="~/ProductionMaster.master" AutoEventWireup="true" CodeBehind="Pro_Rpt_DatewisePrintReport_R2.aspx.cs" Inherits="BLL.Pro_Rpt_DatewisePrintReport_R2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ProductionContent" runat="server">
      <div class="form-horizontal clearfix" runat="server">
                <div class="panel-body" style="border: 1px solid #BDC3CA">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Datewise Print Report
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="col-md-12 no-padding clearfix">
                                <div class="col-md-6 clearfix">
                                    ...
                                    <div class="form-group">
                                        <asp:Label runat="server" AssociatedControlID="ChkCover" CssClass="col-xs-4 control-label no-padding-right" Text="Is Cover"></asp:Label>
                                        <div class="col-xs-8">
                                            <asp:CheckBox ID="ChkCover" runat="server" CssClass="form-control"></asp:CheckBox>
                                        </div>
                                    </div>
