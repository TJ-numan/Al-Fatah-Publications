<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingMaster.master" AutoEventWireup="true" CodeBehind="Mkt_Rpt_DatewiseDonationLetterPayment.aspx.cs" Inherits="BLL.Mkt_Rpt_DatewiseDonationLetterPayment" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MarketingContent" runat="server">
     <div class="form-horizontal clearfix" runat="server">
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    Datewise Donation Payment Report
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                         <div class="input-group col-md-8 col-md-offset-4">
                              <asp:CheckBox CssClass="" ID="chkTerritoryWise" runat="server" />
                              <asp:Label AssociatedControlID="chkTerritoryWise" CssClass="control-label" runat="server" Text="Territory Wise"></asp:Label>
                         </div>
                    </div>
                    <div class="form-group">
                         <div class="input-group col-md-8 col-md-offset-4">
                             <asp:CheckBox CssClass="" ID="chkLetterWise" runat="server" />
                             <asp:Label AssociatedControlID="chkLetterWise" CssClass="control-label" runat="server" Text="Letter Wise"></asp:Label>
                         </div>
                    </div>
                    <div class="form-group">
