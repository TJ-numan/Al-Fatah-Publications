...
namespace BLL
{
    public partial class RnD_WorkOrderBillUpdateQawmi : System.Web.UI.Page
    {
        string FormID = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    //LoadBookBySection();
                    gvDateWiseWorkOrderDetails.DataSource = Li_RnDQawmiWorkOrderDetailsManager.GetLi_RnDWorkOrderBillUpdateInfoByOrderNo(txtEmpName.Text.ToString(), int.Parse(Session["UserID"].ToString()));
        ...
        protected void gvDateWiseWorkDetails_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                try
                {
                    ...
                    DataTable dtWorkDetails = Li_RnDQawmiWorkOrderDetailsManager.GetLi_RnDWorkOrderBillDetailsByBillNo(Int32.Parse(ViewState["BillNo"].ToString())).Tables[0];
        ...
        protected void btnUpdate_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                Li_RnDQawmiWorkOrderDetailsManager.UpdateLi_RnDWorkOrderBill(WorkOderBill);
