...
namespace BLL
{
    public partial class Mkt_Rpt_DatewisePacketBill : System.Web.UI.Page
    {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                rd.Load(Server.MapPath(@"~/Reports/MKT/rptDailyPacketTransportationCost.rpt"));
                ...
                {
                    rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "DatewisePacketReport");
                }

                else if (ddlViewers.SelectedValue == "2")
                {
                    rd.ExportToHttpResponse(ExportFormatType.ExcelRecord, Response, false, "DatewisePacketReport");
                }


                else if (ddlViewers.SelectedValue == "3")
                {
                    rd.ExportToHttpResponse(ExportFormatType.WordForWindows, Response, false, "DatewisePacketReport");
                }
