<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingMaster.master" AutoEventWireup="true" CodeBehind="Mkt_Rpt_IncentiveReport1stAnd2ndStep.aspx.cs" Inherits="BLL.Mkt_Rpt_IncentiveReport1stAnd2ndStep" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MarketingContent" runat="server">
      <div class="form-horizontal clearfix" runat="server">
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    Incentive Report 1st and 2nd Step
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="input-group col-md-8 col-md-offset-4">
                            <asp:CheckBox CssClass="" ID="chk1stStepIncentive" runat="server" AutoPostBack="true" OnCheckedChanged="chk1stStepIncentive_CheckedChanged"/>
                            <asp:Label AssociatedControlID="chk1stStepIncentive" CssClass="control-label" runat="server" Text="1st Step Incentive"></asp:Label>
                        </div>
                    </div>
                    <div class="form-group">
