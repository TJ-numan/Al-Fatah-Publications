...
namespace BLL
{
    public partial class Mkt_RptMadrashaStudentInformation : System.Web.UI.Page
    {
        string FormID = "MR058";
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                rd.Load(Server.MapPath(@"~/Reports/MKT/rptTeritorywiseNoOfStudentByMadrasah.rpt"));
                ...
                //rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "Madrasha Donation Summary");
                ...
                {
                    rd.ExportToHttpResponse(ExportFormatType.ExcelRecord, Response, false, "Madrasha Donation Summary");
                }


                else if (ddlViewers.SelectedValue == "3")
                {
                    rd.ExportToHttpResponse(ExportFormatType.WordForWindows, Response, false, "Madrasha Donation Summary");
                }
