...
namespace BLL
{
    public partial class Rnd_UpdateWorkDetailsQawmi : System.Web.UI.Page
    {
        string FormID = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    gvDateWiseWorkDetails.DataSource = Li_RnDWorkDetailsManager.Get_DateWiseRnDWorkDetailsQawmi(dtpFromDate.Text, dtpToDate.Text, ddlEmpName.SelectedValue);
        ...
        protected void gvDateWiseWorkDetails_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    GridViewRow row = gvDateWiseWorkDetails.SelectedRow;
                    ViewState["WorkDetailID"] = row.Cells[1].Text;
                    DataTable dtLibrary = Li_RnDWorkDetailsManager.GetLi_RnDWorkDetailsByWorkIDQawmi(Int32.Parse(ViewState["WorkDetailID"].ToString())).Tables[0];
        ...
        protected void btnUpdate_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                Li_RnDWorkDetailsManager.UpdateLi_RnDWorkDetailsQawmi(workDetails);
