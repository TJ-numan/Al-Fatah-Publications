<%@ Page Title="Pasting Order" Language="C#" MasterPageFile="~/ProductionMaster.master" AutoEventWireup="true" CodeBehind="Pro_PastingOrder.aspx.cs" Inherits="BLL.Pro_PastingOrder" %>
                                ...
                                <div class="table-responsive">
                                    <table class="table no-head-padding">
                                        ...
                                        <tr id="inner">
                                            ...
                                            <td>
                                                <asp:TextBox ID="txt_inner5color" CssClass="form-control calc-inner" runat="server" />
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txt_inner4color" CssClass="form-control calc-inner" runat="server" />
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txt_inner3color" CssClass="form-control calc-inner" runat="server" />
                                            </td>
                                            <td>
                                        ...
                                        <tr id="forma">
                                            ...
                                            <td>
                                                <asp:TextBox ID="txt_forma5color" CssClass="form-control calc-forma" runat="server" />
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txt_forma4color" CssClass="form-control calc-forma" runat="server" />
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txt_forma3color" CssClass="form-control calc-forma" runat="server" />
                                            </td>
                                            <td>
                                        ...
                                        <tr id="postani">
                                            ...
                                            <td>
                                                <asp:TextBox ID="txt_postani5color" CssClass="form-control calc-postani" runat="server" />
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txt_postani4color" CssClass="form-control calc-postani" runat="server" />
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txt_postani3color" CssClass="form-control calc-postani" runat="server" />
                                            </td>
                                            <td>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                ...
                                <asp:Button ID="btnPOPrint" Text="Print" CssClass="btn btn-info pull-right" runat="server" OnClick="btnPOPrint_Click" />
