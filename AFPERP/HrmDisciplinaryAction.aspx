<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.master" AutoEventWireup="true" CodeBehind="HrmDisciplinaryAction.aspx.cs" Inherits="BLL.HrmDisciplinaryAction" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel panel-primary">
                ...
                <div class="panel-body">
                        ...
                        <div class="form-group">
                            <asp:Label AssociatedControlID="txtActionTitle" runat="server" CssClass="control-label col-md-2 no-padding-right">Action Title</asp:Label>
                            <div class="col-md-4">
                                <asp:TextBox ID="txtActionTitle" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <asp:Label AssociatedControlID="txtActionDescr" runat="server" CssClass="control-label col-md-2 no-padding-right">Action Description</asp:Label>
                            <div class="col-md-4">
                                <asp:TextBox ID="txtActionDescr" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <asp:Label AssociatedControlID="File1" runat="server" CssClass="control-label col-md-2 no-padding-right">Action Document</asp:Label>
                            <div class="col-md-4">
                                <%--<asp:FileUpload ID="txtActionDocUpload" CssClass="form-control" runat="server"></asp:FileUpload>--%>
