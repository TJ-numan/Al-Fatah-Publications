<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.master" AutoEventWireup="true" CodeBehind="HrmLeaveStatus.aspx.cs" Inherits="BLL.HrmLeaveStatus" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <asp:Label AssociatedControlID="ddlPeriod" runat="server" CssClass="control-label col-md-2 no-padding-right">Period</asp:Label>
                        <div class="col-md-4">
                            <asp:DropDownList ID="ddlPeriod" CssClass="form-control" runat="server"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <asp:Label AssociatedControlID="txtAlotment" runat="server" CssClass="control-label col-md-2 no-padding-right">Alotment</asp:Label>
                        <div class="col-md-4">
                            <asp:TextBox ID="txtAlotment" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                    </div>

                    <div class="form-group">
                        <asp:Label AssociatedControlID="txtLeaveTaken" runat="server" CssClass="control-label col-md-2 no-padding-right">Leave Taken</asp:Label>
                        <div class="col-md-4">
                            <asp:TextBox ID="txtLeaveTaken" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                    </div>
