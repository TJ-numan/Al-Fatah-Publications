...
namespace BLL
{
    public partial class Pro_Rpt_DatewisePestingReport : System.Web.UI.Page
    {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                rd.Load(Server.MapPath(@"~/Reports/PRO/rptDatewisePestingReport.rpt"));
                ...
                rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "Central Stock Inventory");
            }
            catch (Exception ex)
            {
