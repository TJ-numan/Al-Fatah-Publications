...
namespace BLL
{
    public partial class Store_Rpt_DatewiseStockReceive : System.Web.UI.Page
    {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                rd.Load(Server.MapPath(@"~/Reports/Store/rptDatewiseGodownReceive.rpt"));
                ...
                rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "Datewise Stock Receive Report");
            }
            catch (Exception ex)
            {
