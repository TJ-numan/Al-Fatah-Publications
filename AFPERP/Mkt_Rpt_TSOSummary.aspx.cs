...
namespace BLL
{
    public partial class Mkt_Rpt_TSOSummary : System.Web.UI.Page
    {
        ...
        protected void ddlDivision_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                LoadComboData.LoadTeritoryByZone(ddlTeritory, int.Parse(ddlDivision.SelectedValue.ToString()));
                ddlTeritory.DataBind();
            }
            catch (Exception)
            {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                rd.Load(Server.MapPath(@"~/Reports/MKT/rptTsoWholeYearSummaryReport.rpt"));
                ...
                rd.SetParameterValue("@ZoneID", int.Parse(ddlDivision.SelectedValue));
                rd.SetParameterValue("@TerritoryCode", ddlTeritory.SelectedValue);
                rd.SetParameterValue("@Com", chkQawmi.Checked ? 1 : 0);
                //rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "SpecimanSummaryReport");
                ...
                {
                    rd.ExportToHttpResponse(ExportFormatType.ExcelRecord, Response, false, "SpecimanSummaryReport");
                }


                else if (ddlViewers.SelectedValue == "3")
                {
                    rd.ExportToHttpResponse(ExportFormatType.WordForWindows, Response, false, "SpecimanSummaryReport");
                }
