<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingMaster.master" AutoEventWireup="true" CodeBehind="Mkt_CashAgentList.aspx.cs" Inherits="BLL.Mkt_CashAgentList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MarketingContent" runat="server">
 <div class="form-horizontal clearfix" runat="server">
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    View Cash Agent List Report
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="dropdown col-md-5">
                            <asp:DropDownList ID="ddlCompany" runat="server" CssClass="form-control">
                                ...
                                <asp:ListItem Value="1">Al Fatah Sales Center</asp:ListItem>
