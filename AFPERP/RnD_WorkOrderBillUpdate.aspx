<%@ Page Title="" Language="C#" MasterPageFile="~/RandDMaster.master" AutoEventWireup="true" CodeBehind="RnD_WorkOrderBillUpdate.aspx.cs" Inherits="BLL.RnD_WorkOrderBillUpdate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="RandDContent" runat="server">
<div class="form-horizontal clearfix" runat="server">
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    Work Order Bill Update
                </div>
                    ...
                    <div class="panel-body" >
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7"> 
                                        <asp:TextBox CssClass="form-control" ID="txtRate" placeholder="Ex. 5000" runat="server" Visible="false" AutoPostBack="True" OnTextChanged="txtQtyChange_TextChanged"/>
                                    </div>
                               </div>
                                <div class="form-group">
                                    <asp:Label AssociatedControlID="txtTotalAmount" ID="lblTotalAmount" CssClass="col-md-3 control-label" Text="Total Amount" Visible="false" runat="server"></asp:Label>
                                    <div class="col-md-7"> 
