...
namespace BLL
{
    public partial class Mkt_Rpt_TerritoryWiseBooksChallan : System.Web.UI.Page
    {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                rd.Load(Server.MapPath(@"~/Reports/MKT/rptTerritoryWiseBookCodeQtyNat.rpt"));
                ...
                rd.SetParameterValue("@B_Session", ddlSession.SelectedValue);
                ...
                {
                    rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "TerritoryBooksChalanReport");
                }

                else if (ddlViewers.SelectedValue == "2")
                {
                    rd.ExportToHttpResponse(ExportFormatType.ExcelRecord, Response, false, "TerritoryBooksChalanReport");
                }


                else if (ddlViewers.SelectedValue == "3")
                {
                    rd.ExportToHttpResponse(ExportFormatType.WordForWindows, Response, false, "TerritoryBooksChalanReport");
                }
