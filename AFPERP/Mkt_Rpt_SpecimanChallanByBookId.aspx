<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingMaster.master" AutoEventWireup="true" CodeBehind="Mkt_Rpt_SpecimanChallanByBookId.aspx.cs" Inherits="BLL.Mkt_Rpt_SpecimanChallanByBookId" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    View Speciman Challan By Book Id Report
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <asp:Label AssociatedControlID="ddlBookName" runat="server" CssClass="col-md-4 control-label" Text="Book Name" />
                        <div class="dropdown col-md-5">
                            <asp:DropDownList ID="ddlBookName" runat="server" CssClass="form-control"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="form-group">
                        <asp:Label AssociatedControlID="ddlEdition" runat="server" CssClass="col-md-4 control-label" Text="Edition" />
                        <div class="dropdown col-md-5">
