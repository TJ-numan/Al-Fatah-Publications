...
namespace BLL
{
    public partial class Pro_Rpt_BinderWiseReport : System.Web.UI.Page
    {
        string FormID = "PF040";
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                rd.Load(Server.MapPath(@"~/Reports/PRO/rptBookReceiveQtyByBookCode_Modified.rpt"));
                rd.DataSourceConnections.Clear();
                rd.DataSourceConnections[0].SetConnection(DAO.ServerName, DAO.DatabaseName, false);
                rd.DataSourceConnections[0].SetLogon(DAO.UserID, DAO.Password);
                rd.SetParameterValue("@FromDate", dtpFromDate.Text);
                rd.SetParameterValue("@ToDate", dtpToDate.Text);
                rd.SetParameterValue("@BinderCode", ddlBookBinderName.SelectedValue);
                ...
                rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "Binder Wise Report");
            }
            catch (Exception ex)
            {
