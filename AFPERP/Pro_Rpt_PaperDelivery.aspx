<%@ Page Title="" Language="C#" MasterPageFile="~/ProductionMaster.master" AutoEventWireup="true" CodeBehind="Pro_Rpt_PaperDelivery.aspx.cs" Inherits="BLL.Pro_Rpt_PaperDelivery" %>
                    ...
                    <div class="col-md-12 no-padding clearfix">
                        <div class="col-md-6 clearfix">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <asp:DropDownList ID="ddlSize" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlSize_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                </div>
                            </div>
                            <div class="form-group">
