<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingMaster.master" AutoEventWireup="true" CodeBehind="Mkt_Rpt_CashAgentBonus.aspx.cs" Inherits="BLL.Mkt_Rpt_CashAgentBonus" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MarketingContent" runat="server">
    <div class="form-horizontal clearfix" runat="server">
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h4>View Cash Agent Bonus Statement Report</h4>
                </div>
