...
namespace BLL
{
    public partial class Pro_printDatewisepaperReturn : System.Web.UI.Page
    {
        string FormID = "MR014";
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            ...
            rd.Load(Server.MapPath(@"~/Reports/PRO/rptPrintPaperReturnDatewise.rpt"));
            ...
            rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "DatewisePaperReturn");
            rd.Close();
            rd.Dispose();
        }
