...
namespace BLL
{
    public partial class RnD_WorkOrderTransfer : System.Web.UI.Page
    {
        string FormID = "";
        ...
        protected void gvDateWiseWorkDetails_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                try
                {
                    ...
                    DataTable dtWorkDetails = Li_RnDWorkOrderDetailsManager.GetLi_RnDWorkOrderDetailsByWorkOrderDetIDForTransfer(Int32.Parse(ViewState["WorkOrderDetID"].ToString())).Tables[0];
        ...
        protected void btnTranfer_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                gvDateWiseWorkOrderDetails.DataSource = Li_RnDWorkOrderDetailsManager.GetLi_RnDWorkOrderDetailsByWorkIDforBillGenerate(txtEmpName.Text, int.Parse(Session["UserID"].ToString()));
