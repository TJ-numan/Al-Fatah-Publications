...
namespace BLL
{
    public partial class Pro_Rpt_PrintOrderReport : System.Web.UI.Page
    {
        string FormID = "PF061";
 ...
 ReportDocument rd = new ReportDocument();
        protected void btnShow_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                rd.Load(Server.MapPath(@"~/Reports/PRO/rptPaperActualUsedReport.rpt"));
                ...
                rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "Print Order Report");
