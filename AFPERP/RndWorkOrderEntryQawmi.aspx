<%@ Page Title="" Language="C#" MasterPageFile="~/RandDMaster.master" AutoEventWireup="true" CodeBehind="RndWorkOrderEntryQawmi.aspx.cs" Inherits="BLL.RndWorkOrderEntryQawmi" %>
                ...
                <div class="col-md-6">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">                    
                            ...
                            <div class="form-group">
                                <asp:Label AssociatedControlID="txtComments" CssClass="col-md-4 control-label no-padding-right" Text="Comments" runat="server"></asp:Label>
                                <div class="col-md-6">
                                    <asp:TextBox CssClass="form-control" ID="txtComments" runat="server"/>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <h4>Qawmi Task Selection for Employee</h4>
                        </div>
                        <div class="panel-body" style="border: 1px solid #BDC3CA">
                            <div class="row">
                                <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            <asp:GridView ID="gvDailyWorks" runat="server" AutoGenerateColumns="False" CssClass="table">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderStyle-Width="200px" HeaderText="Remarks" DataField="Comments" />                                     
