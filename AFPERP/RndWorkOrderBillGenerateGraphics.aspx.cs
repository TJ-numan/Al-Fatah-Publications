...
namespace BLL
{
    public partial class RndWorkOrderBillGenerateGraphics : System.Web.UI.Page
    {
        string FormID = "";
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gvWorkOderDetails.DataSource = Li_RnDWorkOrderDetailsManager.GetLi_RnDWorkOrderDetailsByWorkIDforBillGenerateGraphics(txtWorkOrder.Text.ToString(), int.Parse(Session["UserID"].ToString()));
            ...
            try
            {
                for (int i = 0; i < gvWorkOderDetails.Rows.Count; i++)
                {
                    ...
                    if (chkRow.Checked == true)
                    {
                        ...
                        decimal totchar = Convert.ToDecimal(gvWorkOderDetails.Rows[i].Cells[14].Text);
                        ...
                        WorkOderBill.TotalForma = decimal.Parse(((TextBox)gvWorkOderDetails.Rows[i].FindControl("txtRate")).Text);
                        WorkOderBill.CreatedBy = int.Parse(Session["UserID"].ToString());
                        WorkOderBill.CreatedDate = DateTime.Now;
                        Li_RnDWorkOrderDetailsManager.InsertLi_RnDWorkOrderBillGraphics(WorkOderBill);
                    }
