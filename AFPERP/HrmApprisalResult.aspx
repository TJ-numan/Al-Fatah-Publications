<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.master" AutoEventWireup="true" CodeBehind="HrmApprisalResult.aspx.cs" Inherits="BLL.HrmApprisalResult" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel panel-primary">
                ...
                <div class="panel-body">
                        ...
                        <div class="form-group">
                            <asp:Label AssociatedControlID="ddlApprisalExecution" runat="server" CssClass="control-label col-md-2 no-padding-right">Apprisal Execution</asp:Label>
                            <div class="col-md-4">
                                <asp:DropDownList ID="ddlApprisalExecution" CssClass="form-control" runat="server"></asp:DropDownList>
                            </div>
                        </div>    
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:TextBox ID="chkIsApproved" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
