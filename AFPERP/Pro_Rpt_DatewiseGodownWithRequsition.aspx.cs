...
namespace BLL
{
    public partial class Pro_Rpt_DatewiseGodownWithRequsition : System.Web.UI.Page
    {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                rd.Load(Server.MapPath(@"~/Reports/PRO/rptPrintReqisitonDetailWithGodownReceive.rpt"));
                ...
                rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, " Godown Receive From Requisition Report");
            }
            catch (Exception ex)
            {
