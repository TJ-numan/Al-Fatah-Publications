<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.master" AutoEventWireup="true" CodeBehind="HrmResourcePersonSkill.aspx.cs" Inherits="BLL.HrmResourcePersonSkill" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HRContent" runat="server">
     <div class="form-horizontal clearfix" runat="server">
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel panel-primary">
                <div class="panel-heading">
                    Resource Person Skill
                </div>
                <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:TextBox ID="ddlResourcePerson" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div> 
                        <div class="form-group">
                            <asp:Label AssociatedControlID="txtResourceSkill" runat="server" CssClass="control-label col-md-2 no-padding-right">Resource Skill</asp:Label>
                            <div class="col-md-4">
                                <asp:TextBox ID="txtResourceSkill" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
