<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingMaster.master" AutoEventWireup="true" CodeBehind="Mkt_RptMonthwiseTarget.aspx.cs" Inherits="BLL.Mkt_RptMonthwiseTarget" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MarketingContent" runat="server">
    <div class="form-horizontal clearfix" runat="server">
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    Monthwise Target & Acheivement Report
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <asp:DropDownList ID="ddlYear" runat="server" Width="377" TabIndex="4" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlYear_SelectedIndexChanged">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <asp:DropDownList ID="ddlMonth" runat="server" Width="377" TabIndex="4" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlMonth_SelectedIndexChanged">
                               ...
                               <div class="form-group">
                        <asp:Label runat="server" AssociatedControlID="dtpFromDate" CssClass="col-md-4 control-label" Text="From Date"></asp:Label>
                        <div class="col-md-5">
                            <asp:TextBox ID="dtpFromDate" runat="server" Text="" ReadOnly="true"></asp:TextBox>
                        </div>
                    </div>


                    <div class="form-group">
                        <asp:Label runat="server" AssociatedControlID="dtpToDate" CssClass="col-md-4 control-label" Text="To Date"></asp:Label>
                        <div class="col-md-5">
                            <asp:TextBox ID="dtpToDate" runat="server" Text="" ReadOnly="true"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
