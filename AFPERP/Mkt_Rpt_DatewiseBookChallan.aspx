<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingMaster.master" AutoEventWireup="true" CodeBehind="Mkt_Rpt_DatewiseBookChallan.aspx.cs" Inherits="BLL.Mkt_Rpt_DatewiseBookChallan" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    View Datewise Book Chalan Report
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-md-8 col-md-offset-4">
                            <asp:Label ID="lblMsg" CssClass="control-label" runat="server" Text=""></asp:Label>
                        </div>
                    </div>
                    <div class="form-group">
