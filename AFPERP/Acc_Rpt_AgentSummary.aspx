<%@ Page Title="" Language="C#" MasterPageFile="~/AccountingMaster.master" AutoEventWireup="true" CodeBehind="Acc_Rpt_AgentSummary.aspx.cs" Inherits="BLL.Acc_Rpt_AgentSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="RequiredJSAcc" runat="server">
        <script type="text/javascript">
            $(document).ready(function () {
                open_menu("Reports", "Credit Agents");
            });
    </script>
</asp:Content>
