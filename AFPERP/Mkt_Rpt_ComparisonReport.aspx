<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingMaster.master" AutoEventWireup="true" CodeBehind="Mkt_Rpt_ComparisonReport.aspx.cs" Inherits="BLL.Mkt_Rpt_ComparisonReport" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="input-group col-md-8 col-md-offset-4">
                            <asp:CheckBox CssClass="" ID="chkNetChallan" runat="server" />
                            <asp:Label AssociatedControlID="chkNetChallan" CssClass="control-label" runat="server" Text="View as Direct Challan"></asp:Label>
                        </div>
                    </div>

                    <div class="form-group">
                        <div class="input-group col-md-8 col-md-offset-4">
                            <asp:CheckBox CssClass="" ID="chkCompareWith" runat="server" />
                            <asp:Label AssociatedControlID="chkCompareWith" CssClass="control-label" runat="server" Text="Compare With (2018-2019)"></asp:Label>
                        </div>
                    </div>
