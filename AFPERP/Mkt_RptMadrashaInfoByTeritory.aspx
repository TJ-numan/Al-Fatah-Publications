<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingMaster.master" AutoEventWireup="true" CodeBehind="Mkt_RptMadrashaInfoByTeritory.aspx.cs" Inherits="BLL.Mkt_RptMadrashaInfoByTeritory" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <asp:Label AssociatedControlID="ddlDonationFor" Text="Select Type" CssClass="col-md-4 control-label" runat="server"></asp:Label>
