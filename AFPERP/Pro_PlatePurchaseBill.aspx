<%@ Page Title="Plate Purhcase Bill" Language="C#" MasterPageFile="~/ProductionMaster.master" AutoEventWireup="true" CodeBehind="Pro_PlatePurchaseBill.aspx.cs" Inherits="BLL.Pro_PlatePurchaseBill" %>
                                    ...
                                    <div class="col-md-8 table-responsive">
                                        <asp:GridView runat="server" CssClass="table grid-view" ID="gvwReceiveDetails" AutoGenerateColumns="False">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="TotalPlateQty" HeaderText="Plate Qty" />
                                                <asp:BoundField DataField="Pur_ID" HeaderText="PurchaseOrder" />
