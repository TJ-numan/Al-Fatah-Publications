...
namespace BLL
{
    public partial class Pro_Rpt_PrintRequisitionWithGodownRec : System.Web.UI.Page
    {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                rd.Load(Server.MapPath(@"~/Reports/MKT/rptPrintReqisitonDetailWithGodownReceive.rpt"));
                ...
                //rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "Print Requisition with Godown Receive Report");
                ...
                {
                    rd.ExportToHttpResponse(ExportFormatType.ExcelRecord, Response, false, "Print Requisition with Godown Receive Report");
                }


                else if (ddlViewers.SelectedValue == "3")
                {
                    rd.ExportToHttpResponse(ExportFormatType.WordForWindows, Response, false, "Print Requisition with Godown Receive Report");
                }
