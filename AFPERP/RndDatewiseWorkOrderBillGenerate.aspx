<%@ Page Title="" Language="C#" MasterPageFile="~/RandDMaster.master" AutoEventWireup="true" CodeBehind="RndDatewiseWorkOrderBillGenerate.aspx.cs" Inherits="BLL.RndDatewiseWorkOrderBillGenerate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="RandDContent" runat="server">
    <div class="form-horizontal clearfix" runat="server">
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    Datewise Work Order Bill Generate
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <asp:Button ID="btnShow" Text="Show Work Order"  CssClass="btn btn-success" runat="server" OnClick="btnShow_Click" />
                        ...
                        <div class="table-responsive table-bordered clearfix ">
                            <asp:GridView ID="gvDateWiseMRSheet" CssClass="table " runat="server" AutoGenerateColumns="false" OnRowDataBound="gvDateWiseMRSheet_RowDataBound" OnSelectedIndexChanged="gvDateWiseMRSheet_SelectedIndexChanged">
                                ...
                                <Columns>
                                    ...
                                    <asp:CommandField SelectText="Update" ShowSelectButton="true" Visible="true" ItemStyle-CssClass="btn btn-compose"
