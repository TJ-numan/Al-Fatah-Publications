...
namespace BLL
{
    public partial class RnDWorkOrderBillPrintQawmi : System.Web.UI.Page
    {
        string FormID = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    gvDateWiseWorkOrderDetails.DataSource = Li_RnDQawmiWorkOrderDetailsManager.GetLi_RnDWorkOrderBillPrintInfoByOrderNo(txtEmpName.Text.ToString(), int.Parse(Session["UserID"].ToString()));
