...
namespace BLL
{
    public partial class RnD_WorkOrderUpdateQawmi : System.Web.UI.Page
    {
        string FormID = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    //LoadBookBySection();
                    LoadBookSize();
                    gvDateWiseWorkOrderDetails.DataSource = Li_RnDQawmiWorkOrderDetailsManager.GetRndWorkOrderUpdateSearchByEmployeeName(txtEmpName.Text, int.Parse(Session["UserID"].ToString()));
        ...
        protected void gvDateWiseWorkDetails_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                try
                {
                    ...
                    DataTable dtWorkDetails = Li_RnDQawmiWorkOrderDetailsManager.GetLi_RnDWorkOrderDetailsByWorkOrderDetID(Int32.Parse(ViewState["WorkOrderDetID"].ToString())).Tables[0];
        ...
        protected void btnUpdate_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                Li_RnDQawmiWorkOrderDetailsManager.UpdateLi_RnDWorkOrderDetails(WorkOderBill);
