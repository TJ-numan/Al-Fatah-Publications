...
namespace BLL
{
    public partial class Pro_Rpt_DatewisePrintReport_R2 : System.Web.UI.Page
    {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                rd.Load(Server.MapPath(@"~/Reports/PRO/rptDatewisePrintReportR2.rpt"));
                ...
                rd.SetParameterValue("@IsCover", ChkCover.Checked == true ? true : false);
                rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "Datewise Print Report");
            }
            catch (Exception ex)
            {
