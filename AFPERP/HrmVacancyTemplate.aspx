<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.master" AutoEventWireup="true" CodeBehind="HrmVacancyTemplate.aspx.cs" Inherits="BLL.HrmVacancyTemplate" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel panel-primary">
                ...
                <div class="panel-body">
                        ...
                        <div class="form-group">
                            <asp:Label AssociatedControlID="upldTemplatePath" runat="server" CssClass="control-label col-md-2 no-padding-right">Template Path</asp:Label>
                            <div class="col-md-4">
                                <asp:FileUpload ID="upldTemplatePath" CssClass="form-control" runat="server"></asp:FileUpload>
                            </div>
                        </div>                 
