...
namespace BLL
{
    public partial class Mkt_Rpt_AgentSummary : System.Web.UI.Page
    {
        string FormID = "MR031";
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                if(chkWithCash.Checked == true)
                {
                rd.Load(Server.MapPath(@"~/Reports/MKT/rptYearlyTransectionReport_ModifiedwithCash.rpt"));
                }
                else
                {
                rd.Load(Server.MapPath(@"~/Reports/MKT/rptYearlyTransectionReport_Modified.rpt"));
                }
                ...
                {
                    rd.ExportToHttpResponse(ExportFormatType.ExcelRecord, Response, false, "AgentSummary");
                }


                else if (ddlViewers.SelectedValue == "3")
                {
                    rd.ExportToHttpResponse(ExportFormatType.WordForWindows, Response, false, "AgentSummary");
                }
