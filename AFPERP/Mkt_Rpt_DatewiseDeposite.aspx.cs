...
namespace BLL
{
    public partial class Mkt_Rpt_DatewiseDeposite : System.Web.UI.Page
    {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            ...
            rd.Load(Server.MapPath(@"~/Reports/MKT/rptDatewiseDpositeByDaterange.rpt"));
            ...
            rd.SetParameterValue("@Boishaki", chkIsBoishaki.Checked ? 1: 0);
            rd.SetParameterValue("@Alim", chkIsAlim.Checked ? 1 : 0);
