...
namespace BLL
{
    public partial class Mkt_Rpt_ComparisonReport2020 : System.Web.UI.Page
    {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                if(chkIsQawmi.Checked == false)
                {
                        ...
                        {
                            rd.Load(Server.MapPath(@"~/Reports/MKT/QAWMI/rptFiveYearsComparisonReport.rpt"));
                        }
                        else if (ddlRegion.SelectedValue != "0" && ddlDivision.SelectedValue == "0")
                        {
                            rd.Load(Server.MapPath(@"~/Reports/MKT/LastThreeYearCompReportReg.rpt"));
                        }
                        else if (ddlRegion.SelectedValue != "0" && ddlDivision.SelectedValue != "0" && ddlTeritory.SelectedIndex == 0)
                        {
                            rd.Load(Server.MapPath(@"~/Reports/MKT/LastThreeYearCompReportDiv.rpt"));
                        }
                        else{
                            rd.Load(Server.MapPath(@"~/Reports/rptProjectwiseSalesComparisonReport2016_2019.rpt"));
                        }
                ...
                if (chkIsQawmi.Checked == true)
                {
                        if (ddlRegion.SelectedValue == "0")
                        {
                            rd.Load(Server.MapPath(@"~/Reports/MKT/QAWMI/LastThreeYearCompReportNatQ.rpt"));
                        }
                        else if (ddlRegion.SelectedValue != "0" && ddlDivision.SelectedValue == "0")
                        {
                            rd.Load(Server.MapPath(@"~/Reports/MKT/QAWMI/LastThreeYearCompReportRegQ.rpt"));
                        }
                        else if (ddlRegion.SelectedValue != "0" && ddlDivision.SelectedValue != "0" && ddlTeritory.SelectedIndex == 0)
                        {
                            rd.Load(Server.MapPath(@"~/Reports/MKT/QAWMI/LastThreeYearCompReportDivQ.rpt"));
                        }
                        else{
                            rd.Load(Server.MapPath(@"~/Reports/rptProjectwiseSalesComparisonReportQawmi2019_2020Qawmi.rpt"));
                        }
