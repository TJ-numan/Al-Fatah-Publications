...
namespace BLL
{
    public partial class Rnd_Rpt_DailyWorkSectionWise : System.Web.UI.Page
    {
        string FormID = "RF008";
        ...
        protected void btnShow_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    rd.Load(Server.MapPath(@"~/Reports/RND/rptDailyWorkReportBySection.rpt"));
                }
                else
                {
                    rd.Load(Server.MapPath(@"~/Reports/RND/rptDailyWorkReportByIndividualSection.rpt"));
                }
        ...
        protected void btnDownloadExcel_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand command = new SqlCommand("SMPM_li_rptRND_DailyReportBySection", connection);
                ...
                Response.AddHeader("content-disposition", "attachment;filename=SectionWiseDailyWorks.xls");
