...
namespace BLL
{
    public partial class Mkt_RptMadrasahListByDem : System.Web.UI.Page
    {
        string FormID = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    //LoadCategory.LoadEdition(ddlEdition);
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                rd.Load(Server.MapPath(@"~/Reports/MKT/rptMadrasahListByDem.rpt"));
                ...
                rd.SetParameterValue("@Grade", ddlGrade.SelectedValue);
