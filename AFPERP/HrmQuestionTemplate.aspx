<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.master" AutoEventWireup="true" CodeBehind="HrmQuestionTemplate.aspx.cs" Inherits="BLL.HrmQuestionTemplate" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <asp:Label AssociatedControlID="txtQuesTempTitle" runat="server" CssClass="control-label col-md-2 no-padding-right">QuesTempTitle</asp:Label>
                        <div class="col-md-4">
                            <asp:TextBox ID="txtQuesTempTitle" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
