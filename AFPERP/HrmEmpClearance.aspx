<%@ Page Title="" Language="C#" MasterPageFile="~/HRMaster.master" AutoEventWireup="true" CodeBehind="HrmEmpClearance.aspx.cs" Inherits="BLL.HrmEmpClearance" %>
        ...
        <div class="panel-body" style="border: 1px solid #BDC3CA">
            <div class="panel panel panel-primary">
                ...
                <div class="panel-body">
                        ...
                        <div class="form-group">
                            <asp:Label AssociatedControlID="txtClearTitle" runat="server" CssClass="control-label col-md-2 no-padding-right">Clear Title</asp:Label>
                            <div class="col-md-4">
                                <asp:TextBox ID="txtClearTitle" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
