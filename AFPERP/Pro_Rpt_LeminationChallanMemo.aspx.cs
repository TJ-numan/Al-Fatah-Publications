...
namespace BLL
{
    public partial class Pro_Rpt_LeminationChallanMemo : System.Web.UI.Page
    {
        string FormID = "PF051";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    txtMemoNo.Text = Request.QueryString["No"];
                }
            }
            catch (Exception ex)
            {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                rd.Load(Server.MapPath(@"~/Reports/PRO/rptLeminationChallanMemo.rpt"));
