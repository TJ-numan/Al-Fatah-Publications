...
namespace BLL
{
    public partial class Mkt_DatewiseMRSheet : System.Web.UI.Page
    {
        string FormID = "MF036";
        ...
        protected void gvDateWiseMRSheet_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("~/MktMRSheetUpdate.aspx?SheetNo=" + MRId + "&SendBefore=" + isSend + "&HeldUp=" + chkHeldUp.Checked);
            }
            catch (Exception)
            {
            ...
            //else
            //{
            //    string message = "This Sheet is Sent To Accounts Department \b This is no longer possible to edit";
