<%@ Page Title="" Language="C#" MasterPageFile="~/Distribution.master" AutoEventWireup="true" CodeBehind="Dist_InvoiceSummary.aspx.cs" Inherits="BLL.Dist_InvoiceSummary" %>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <asp:TextBox CssClass="form-control" ID="txtSummarySL" runat="server" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <asp:Button ID="btnSumPrint" Text="Books Summary Print" CssClass="btn btn-danger btn pull-left" runat="server" OnClick="btnSumPrint_Click"/>
                                    <asp:Button ID="btnMemoPrint" Text="Memo List Print" CssClass="btn btn-info btn pull-left" runat="server"  OnClick="btnMemoPrint_Click"/>
                                    <%--<asp:Button ID="btnMadrasahPrint" Text="Madrasah Print" CssClass="btn btn-danger btn pull-left" runat="server" OnClick="btnMadrasahPrint_Click"/>--%>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive table-bordered clearfix ">
                                <div style="height: 400px; width: 550px; overflow: auto;">
                                    <asp:GridView ID="gvInvoiceDetails" CssClass="table " runat="server" AutoGenerateColumns="false" AllowPaging="false">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Transport" HeaderText="Transport Name" />
                                        </Columns>
