...
namespace BLL
{
    public partial class Mkt_MadrasahInfoQawmi : System.Web.UI.Page
    {
        string FormID = "RF004";
        ...
        {
            ddlClass.DataSource = Li_ClassesManager.GetLi_ClassesByUserID(int.Parse(Session["UserID"].ToString()));
        ...
        protected void ddlClass_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ddlBookName.DataSource = li_BookInformationManager.Get_BookInformations_Combo_BySectionbyUserAndClassID(int.Parse(Session["UserID"].ToString()), int.Parse(ddlClass.SelectedValue.ToString()));
        ...
        protected void txtTopage_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ddlTask.SelectedValue.ToString() == "14")
                {
        ...
        protected void btnSave_OnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                if (dtCurrentTable.Rows.Count > 0)
                {
                    ...
                    string returnworkOrderID = Li_RnDWorkOrderDetailsManager.InsertLi_RnDWorkOrder(_workOrder);
                    ...
                    for (int i = 0; i < dtCurrentTable.Rows.Count; i++)
                    {
                        ...
                        Li_RnDWorkOrderDetailsManager.InsertLi_RnDWorkOrderDetails(workOrderDetails);
                        dtpWorkDate.Focus();
                    }
                    txtWorkID.Text = returnworkOrderID;
        ...
        {
            rd.Load(Server.MapPath(@"~/Reports/RND/rptPrintRnDWorkOrder.rpt"));
        ...
        protected void ddlTask_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (ddlTask.SelectedValue.ToString() != "14")
            {
