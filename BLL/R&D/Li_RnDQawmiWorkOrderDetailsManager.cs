...
public class Li_RnDQawmiWorkOrderDetailsManager
{
    public Li_RnDQawmiWorkOrderDetailsManager()
	{
	}
    public static List<Li_RnDQawmiWorkOrderDetails> GetAllLi_RnDWorkOrderDetails()
    {
        List<Li_RnDQawmiWorkOrderDetails> li_RnDWorkOrderDetails = new List<Li_RnDQawmiWorkOrderDetails>();
        Sqlli_RnDQawmiWorkOrderDetailsProvider sqlLi_RnDWorkDetailsProvider = new Sqlli_RnDQawmiWorkOrderDetailsProvider();
        li_RnDWorkOrderDetails = sqlLi_RnDWorkDetailsProvider.GetAllLi_RnDWorkOrderDetails();
        return li_RnDWorkOrderDetails;
    }


    public static Li_RnDQawmiWorkOrderDetails GetLi_RnDWorkOrderDetailsByID(int id)
    {
        Li_RnDQawmiWorkOrderDetails li_RnDWorkOrderDetails = new Li_RnDQawmiWorkOrderDetails();
        Sqlli_RnDQawmiWorkOrderDetailsProvider sqlLi_RnDWorkDetailsProvider = new Sqlli_RnDQawmiWorkOrderDetailsProvider();
    ...
    public static int InsertLi_RnDWorkOrderDetails(Li_RnDQawmiWorkOrderDetails li_RnDWorkOrderDetails)
    {
        Sqlli_RnDQawmiWorkOrderDetailsProvider sqlLi_RnDWorkOrderDetailsProvider = new Sqlli_RnDQawmiWorkOrderDetailsProvider();
        return sqlLi_RnDWorkOrderDetailsProvider.InsertLi_RnDWorkOrderDetails(li_RnDWorkOrderDetails);
    }


    public static bool UpdateLi_RnDWorkOrderDetails(Li_RnDQawmiWorkOrderDetails li_RnDWorkOrderDetails)
    {
        Sqlli_RnDQawmiWorkOrderDetailsProvider sqlLi_RnDWorkOrderDetailsProvider = new Sqlli_RnDQawmiWorkOrderDetailsProvider();
    ...
    public static string InsertLi_RnDWorkOrder(Li_RnDQawmiWorkOrderDetails li_RnDWorkOrderDetails)
    {
        Sqlli_RnDQawmiWorkOrderDetailsProvider sqlLi_RnDWorkOrderDetailsProvider = new Sqlli_RnDQawmiWorkOrderDetailsProvider();
        return sqlLi_RnDWorkOrderDetailsProvider.InsertLi_RnDWorkOrder(li_RnDWorkOrderDetails);
    }
    public static int InsertLi_RnDWorkOrderBill(Li_RnDQawmiWorkOrderDetails li_RnDWorkOrderDetails)
    {
        Sqlli_RnDQawmiWorkOrderDetailsProvider sqlLi_RnDWorkOrderDetailsProvider = new Sqlli_RnDQawmiWorkOrderDetailsProvider();
    ...
    public static int UpdateLi_RnDWorkOrderBill(Li_RnDQawmiWorkOrderDetails li_RnDWorkOrderDetails)
    {
        Sqlli_RnDQawmiWorkOrderDetailsProvider sqlLi_RnDWorkOrderDetailsProvider = new Sqlli_RnDQawmiWorkOrderDetailsProvider();
    ...
    public static int Delete_Li_RnDWorkOrder(Li_RnDQawmiWorkOrderDetails li_RnDWorkOrderDetails)
    {
        Sqlli_RnDQawmiWorkOrderDetailsProvider sqlLi_RnDWorkOrderDetailsProvider = new Sqlli_RnDQawmiWorkOrderDetailsProvider();
    ...
    public static int TransferLi_RnDWorkOrderDetails(Li_RnDQawmiWorkOrderDetails li_RnDWorkOrderDetails)
    {
        Sqlli_RnDQawmiWorkOrderDetailsProvider sqlLi_RnDWorkOrderDetailsProvider = new Sqlli_RnDQawmiWorkOrderDetailsProvider();
        return sqlLi_RnDWorkOrderDetailsProvider.TransferLi_RnDWorkOrderDetails(li_RnDWorkOrderDetails);
    }
    public static int ApprovalLi_RnDWorkOrderBill(Li_RnDQawmiWorkOrderDetails li_RnDWorkOrderDetails)
    {
        Sqlli_RnDQawmiWorkOrderDetailsProvider sqlLi_RnDWorkOrderDetailsProvider = new Sqlli_RnDQawmiWorkOrderDetailsProvider();
        return sqlLi_RnDWorkOrderDetailsProvider.ApprovalLi_RnDWorkOrderBill(li_RnDWorkOrderDetails);
    }
    public static int RejectLi_RnDWorkOrderBill(Li_RnDQawmiWorkOrderDetails li_RnDWorkOrderDetails)
    {
        Sqlli_RnDQawmiWorkOrderDetailsProvider sqlLi_RnDWorkOrderDetailsProvider = new Sqlli_RnDQawmiWorkOrderDetailsProvider();
    ...
    public static string InsertLi_RnDWorkPlanForNewBook(Li_RnDQawmiWorkOrderDetails li_RnDWorkOrderDetails)
    {
        Sqlli_RnDQawmiWorkOrderDetailsProvider sqlLi_RnDWorkOrderDetailsProvider = new Sqlli_RnDQawmiWorkOrderDetailsProvider();
        return sqlLi_RnDWorkOrderDetailsProvider.InsertLi_RnDWorkPlanForNewBook(li_RnDWorkOrderDetails);
    }
    public static int InsertLi_RnDWorkPlanForNewBookDetails(Li_RnDQawmiWorkOrderDetails li_RnDWorkOrderDetails)
    {
        Sqlli_RnDQawmiWorkOrderDetailsProvider sqlLi_RnDWorkOrderDetailsProvider = new Sqlli_RnDQawmiWorkOrderDetailsProvider();
